...
(function () {
  ...
  // ※ IDが不明なスタッフはコメントを外してIDを追記してください
  var STAFF_MAP = {
    '47848': '小川真央',   // 西新宿
    '47849': '矢澤南奈',   // 西新宿
    '48970': '清瀬陽香',   // 西新宿
  ...
  var SHIFT_ID_MAP = {
    'h11-22':  '14775',  // 11:00-22:00 → 11~22
    'h11-17':  '14776',  // 11:00-17:00 → 11~18（近似値）
    'early':   '14777',  // 13:00-18:00 → 13~18
    'late':    '14780',  // 16:00-22:00 → 17~22（近似値）
    'full':    '14778',  // 13:00-22:00 → 13~22
    'omakase': '1',      // お任せ → 全日
    'off':     null,     // 休日希望（休み扱い）
  };
